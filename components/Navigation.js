    ...
    return (
        ...
        >
            ...
            <NextLink href="/" passHref>
                <Image src="/images/adinyahya.png" w={[null, 40, 70]} h={[null, 50, 70]}></Image>
            </NextLink>
            <Box>
            <NextLink href="/hello" passHref>
                    <Button as="a" variant="ghost" p={[1, 2, 4]} _hover={{ backgroundColor: navHoverBg[colorMode] }} backgroundColor={router.pathname === '/hello' ? navHoverBg[colorMode] : null}>
                        Home
                    </Button>
            </NextLink>
